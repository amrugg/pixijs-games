(function () {
    ...
    $(document).ready(function () {
        ...
        var timerButton = document.getElementById("start-time");
        var timerDisplay = document.getElementById("display-time")
        var startTime = 0;
        var interval;
        ...
        function toggleTimer() {
            ...
            if(startTime) {
                ...
                interval = setInterval(function(){
                    ...
                    var secondsLeft = Math.round((totalTime - timeElapsed) / 1000);
                    if (secondsLeft > 0) {
