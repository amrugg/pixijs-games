...
function hitTestRectangle(r1, r2, offsetX, offsetY, graceX, graceY) {
    offsetX = offsetX || 0;
    offsetY = offsetY || 0;
    graceX = graceX || 0;
    graceY = graceY || 0;
    ...
    if (Math.abs(vx + offsetX) + graceX < combinedHalfWidths) {

        //A collision might be occurring. Check for a collision on the y axis
        if (Math.abs(vy +offsetY) + graceY < combinedHalfHeights) {
